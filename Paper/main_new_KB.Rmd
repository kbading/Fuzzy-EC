...
```{r illustrate-mpt-1, fig.cap = "(ref:intro-model1-label)", out.width="85%", fig.align = 'center'}
...
```{r illustrate-mpt-2, fig.cap = "(ref:intro-model2-label)", out.width="85%", fig.align = 'center'}
