...
A final limitation concerns the interpretation of the $d$ parameter as a measure of US valence memory. By design, the $d$ parameter captures cases in which participants retrieve evaluative information about a previously paired US in the absence of US identity memory. However, this retrieved evaluative information may itself arise from two different sources.

On the one hand, $d$ may reflect explicit, declarative memory for US valence---for example, knowledge that a given CS had been paired with a positive rather than a negative stimulus, without access to the specific US identity. On the other hand, $d$ may also be supported by conditioned attitudes toward the CS that were acquired during learning. In this case, participants may rely on their affective response to the CS as a source of information (“this CS feels positive”) and use this affect-as-information to select a valence-consistent US in the memory task. Unlike unsystematic guessing, such affect-based responding is systematically related to US valence and therefore contributes to above-zero estimates of the $d$ parameter.

From one perspective, this ambiguity may be considered unproblematic. Conditioned attitudes can plausibly be regarded as a form of valence-based memory representation that preserves evaluative information from the learning episode, even if it does not take the form of explicit propositional knowledge. On this view, both sources---explicit valence knowledge and conditioned affect---are theoretically relevant instantiations of US valence memory, and the $d$ parameter appropriately captures their shared functional role in evaluative conditioning.

From another perspective, however, it may be desirable to further distinguish these sources. Future model extensions could aim to separate explicit US valence memory from conditioned affective responses by ...
