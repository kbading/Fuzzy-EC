...
This departure from the preregistration was made to reduce multicollinearity between predictors (since the bivariate correlation between $C_{pos}$ and $C_{neg}$ turned out to be extremely high, `r Ccor$full_result`).
