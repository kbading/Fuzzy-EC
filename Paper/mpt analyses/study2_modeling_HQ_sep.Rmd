...
save(para_ratings_memfirst,file = "HQstudy2memfirst_x_ratings.rdata")
```
...
model_files <- list.files(path = file.path(study_folder), pattern = "^study2_both", full.names = TRUE)
...
saveRDS(waic, file = file.path(study_folder, "waic.rds"))
