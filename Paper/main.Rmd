...
<<<<<<< HEAD
We found that 156 participants were required to achieve a statistical power of $.8$ to detect a significant EC effect.
...
To avoid a final sample smaller than $N = 156$ after applying the pre-registered exclusion criteria, we chose to recruit 172 participants (the required sample size increased by 10%)
>>>>>>> 248cbc97f2b675076e9807f1efcb57a73b0e1290
...
The CS pool comprised 54 5- to 7-letter nonwords which have been used in previous EC research (Stahl & Bading, 2020).
<!-- For each participants, 24 nonwords were randomly selected to serve as CSs during the learning phase. -->
<!-- The remaining and 24 were new (i.e., presented only in the test phase). -->
=======
