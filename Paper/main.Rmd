...
The difference between $C_{positive}$ and $C_{negative}$ was non-significant, xxx, as was the difference between $d_{positive}$ and $d_{negative}$, xxx.
By implication, the restrictive 5-parameter variant of the MPT model (with $C_{positive}=C_{negative}$ and $d_{positive}=d_{negative}$) fit the data well, xxx.
