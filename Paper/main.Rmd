...
The unrestricted 10-parameter model achieved adequate fit, xxx.
...
The pooled data set included $xxx$ participants (none of which gave the same response on all trials of either measurement task.)
...
The mean EC effect in the "valence focus" condition (`r mean_val`, `r sd_val`) was significantly larger than zero, `r t.val$full_result`, while the mean EC effect in the "age focus" condition (`r mean_age`, `r sd_age`) did not differ from zero, `r t.age$full_result`.
...
Parameter estimates and credible intervals from the unrestricted 10-parameters model can be found in Table\ \@ref(tab:exp3-param).
