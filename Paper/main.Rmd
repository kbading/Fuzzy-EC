...
The 8-parameter variant of the MPT model provided an adequate account of the data, `r apa_wsw8b$stat$modelfit`.
...
Note that the $a$ parameter estimate was significantly lower than $.5$, `r apa_wsw_comps$full_result$a_eq.5`, demonstrating an overall tendency towards selecting a negative US.
...
Note that the $b$ parameter estimate was significantly lower than $.5$, `r apa_wsw_comps$full_result$b_eq.5`, demonstrating an overall tendency towards selecting the "new" response.
...
```{r}
model6_exp1 <- afex::lmer(evaluative_rating ~ (cntr(D)+cntr(C)+cntr(d))*us_valence + (1|sid)
