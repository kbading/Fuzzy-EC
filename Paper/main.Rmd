...
Thirdly, we present three experiments demonstrating the suitability and power of the proposed model for studying the relationship between memory and EC.
...
The chance level in a typical measure of US valence memory is thus $.5$ (corresponding to the inverse of the two US valences represented in the measure) and therefore higher than that in measures of US identity memory (assuming that more than two response options are presented).

As explained by @pleyers_aware_2007, the relationships between EC and CS-US pairing memory may be analyzed at the level of participants or at the level of individual CSs.
When discussing the problematic aspects of the previously introduced measures we will therefore distinguish between these two levels of analysis.
