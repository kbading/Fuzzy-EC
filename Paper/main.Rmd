...
plot(
  models_8b$baseline
  # , factors = list("us_valence" = c(positive = "_positive", negative = "_negative"))
  , parameters = c(
      "D" = expression(italic(D))
    , "C_positive" = expression(italic(C)[p])
    , "C_negative" = expression(italic(C)[n])
    , "d_positive" = expression(italic(d)[p])
    , "d_negative" = expression(italic(d)[n])
