...
The 7-parameter variant of the MPT model fit the data well, xxx.
...
By implication, the restrictive 5-parameter variant of the MPT model (with $C_{positive}=C_{negative}$ and $d_{positive}=d_{negative}$) achieved adequate fit as well, xxx.
