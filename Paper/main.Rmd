...
Participants were recruited through Prolific and received £2.25 for their participation (estimated duration: 15 minutes).
...
Subsequently, participants had the chance to comment on the study. Participants were told that their responses would not affect their payment.
...
Because the memory data was also well described by the 5-parameter model (`r fit$model5p$T1`; `r fit$model5p$T2`), we decided to use this simpler model variant also for the preregistered regression analyses (in which we sought to predict individual EC effects from participant-level parameter estimates).
