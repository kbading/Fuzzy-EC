...
```{r}
ratings_and_parameters <- merge(data_list$rating_wide, get_theta(exp1_trait_model))

ratings_and_parameters_long_8b <- merge(data_list$rating, get_theta(exp1_trait_model_8b)) |>
  within({
    d <- ifelse(us_valence == "positive", d_positive, d_negative)
    C <- ifelse(us_valence == "positive", C_positive, C_negative)
  })

ratings_and_parameters_long <- merge(data_list$rating, get_theta(exp1_trait_model))
...
ratings_and_parameters_long_8b <- merge(data_list$rating, get_theta(exp2_trait_model_8b)) |>
  within({
    d <- ifelse(us_valence == "positive", d_positive, d_negative)
    C <- ifelse(us_valence == "positive", C_positive, C_negative)
  })

ratings_and_parameters_long <- merge(data_list$rating, get_theta(exp2_trait_model))
...
```{r}
ratings_and_parameters <- merge(data_list$rating_wide, get_theta(exp3_trait_model))

ratings_and_parameters_pilot <- merge(data_list_pilot$rating_wide, get_theta(exp3pilot_trait_model))

ratings_and_parameters_joint <- merge(data_list_joint$rating_wide, get_theta(exp3joint_trait_model))

ratings_and_parameters_pilot$sid <- paste0(ratings_and_parameters_pilot$sid,"pilot")

ratings_and_parameters_long_8b <- merge(data_list$rating, get_theta(exp3_trait_model_8b)) |>
  within({
    d <- ifelse(us_valence == "positive", d_positive, d_negative)
    C <- ifelse(us_valence == "positive", C_positive, C_negative)
  })

ratings_and_parameters_long_8b_pilot <- merge(data_list_pilot$rating, get_theta(exp3pilot_trait_model_8b)) |>
  within({
    d <- ifelse(us_valence == "positive", d_positive, d_negative)
    C <- ifelse(us_valence == "positive", C_positive, C_negative)
  })
...
ratings_and_parameters_long <- merge(data_list$rating, get_theta(exp3_trait_model))

ratings_and_parameters_long_pilot <- merge(data_list_pilot$rating, get_theta(exp3pilot_trait_model))
