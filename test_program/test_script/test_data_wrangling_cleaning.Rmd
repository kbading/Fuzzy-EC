...
```
# To Do: check whether there are always 4 positive and 4 negative options in the memory task
```{r}
...
Karoline: Im not sure we need to identify the correct US as we already have column 'us' that states the paired US for a given CS. Or am I misunderstanding something here? I figured it might be useful to check if participants chose the correct US for "old" CSs.
