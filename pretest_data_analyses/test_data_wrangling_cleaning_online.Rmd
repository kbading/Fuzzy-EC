...
read_file('C:/Users/benaj/OneDrive - UCL/Postdoctorat/projects_Karoline/study/test_study/online/test_data/data_prest_test.txt')%>%
#... split it into lines ...
 str_split('\n') %>% first() %>%
#... filter empty rows ...
...
saveRDS(dat_final, "data_wsw_final_pretest.RDS") #RDS can handle lists such as in the `uss` list
```
