...
mpt_data_hierarchical <- readRDS(file.path(study_folder, "data", "data-wide.rds"))$mpt_data_hierarchical
...
saveRDS(model, file = file.path(study_folder, "model-objects", "treestan-2-by-2-by-8.rds"))
summary(model)
